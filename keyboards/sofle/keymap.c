 ...
 * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   +  |  '   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   !  |   @  |   #  |   $  |   %  |-------.    ,-------| Left | Down |  Up  |Right | Home | End  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * | Shift|  =   |  -   |  +   |   {  |   }  |-------|    |-------|   [  |   ]  |   <  |   >  |   |  | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 ...
 */
[_LOWER] = LAYOUT( \
  _______,   LGUI(KC_1),   LGUI(KC_2),   LGUI(KC_3),   LGUI(KC_4),   LGUI(KC_5),                       LGUI(KC_6),   LGUI(KC_7),   LGUI(KC_8),   LGUI(KC_9),  _______,  KC_DEL,\
  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_MINS,  KC_BSLS, \
  _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                       KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_HOME, KC_END, \
 ...
 */
[_RAISE] = LAYOUT( \
  _______, _______ , _______ , _______ , _______ , _______,                           _______,  LGUI(KC_F7), LGUI(KC_F8),  LGUI(KC_F9),  _______ ,_______, \
